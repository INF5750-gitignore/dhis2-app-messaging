...
app.controller('ShowAllMessages', function ($scope) {
    $.ajax({
        url: "http://inf5750-8.uio.no/api/messageConversations.json?paging=false&fields=id,created,displayName,followUp,lastSenderSurname,lastSenderFirstname,messages,read,lastUpdated",
        type: 'GET',
        dataType: 'json',
        async: false,
