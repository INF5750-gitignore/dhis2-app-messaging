...
app.controller('ShowAllMessages', function ($scope) {
    $.ajax({
        url: "http://inf5750-8.uio.no/api/messageConversations.json?paging=false&fields=id,displayName,followUp,lastSender,messages,read,lastUpdated", 
        type: 'GET',
        dataType: 'json',
        async: false,
...
app.controller('ShowMessage', function($scope, $routeParams) {
    ...
    $.ajax({
        url: "http://inf5750-8.uio.no/api/messageConversations/" + $routeParams.msgId + ".json?paging=false&fields=*", 
        type: 'GET',
        dataType: 'json',
        async: false,
        success: function (data) {
